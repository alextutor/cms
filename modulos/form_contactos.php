...
if(isset($_POST['submitbutton'])) 
{
	...
	{		
		$sqlcontacto = "INSERT INTO personabuzon 
					...
					VALUES
					('00000001','11061212','".$_POST[nombre]."','1','".$_POST[correo]."','".$asunto."','".$mensaje."',now() )";
		...
		echo "<br>";
		echo "<p align='center'><img src='/webimages/mensajeenviado.jpg'></p>";
...
<div id="formcuenta">
	...
	<form  name="frm_contactos" action="#" method="post">
		...
		<input type="submit" name="submitbutton" id="submitbutton" value="<?=contactos_enviar?>" class="enviar"><br>
	</form>
