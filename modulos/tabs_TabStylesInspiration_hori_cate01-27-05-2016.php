...
.post_TabStylesInspiration .image_post {display: flex;float: left; margin-right: 8px;}
.post_TabStylesInspiration .conteni_post {padding: 0px 5px;box-sizing: border-box;}
...
.post_TabStylesInspiration .titulo_post h1 { font-size:13px; text-align:center; font-weight:bold;}
.post_TabStylesInspiration .titulo_post a:visited {color:#006c97}

.post_TabStylesInspiration .fechainicio {font-size: 13px;font-weight: bold;width: 99%;}
...
<div class="tabs tabs-style-linebox">
  ...
  <article class="post_TabStylesInspiration" class-hover="post_TabStylesInspiration" >
      ...
      <div class="conteni_post">
          ...
          <div class="resumen_post">
          		<div class="fechainicio">Mes de Inicio : <?=traducefecha($rowcontenido1['inicioclases'],"MY")?> </div>                     
               <div class="resumen"><?=nl2br(acortar($rowcontenido1['crescontenido'],200))?></div>       
           </div>                  
