...
<body>
<div id="formDiv"> 
<form   id="formvercarrito" method="post">
     ...
     <?php if($carro){ ?>  
        ...
        <table border="0" align="center" class="items_tablacarritocompras">        
          <tbody><tr>
            ...
            <td class="cantidad_tabla"><input name="cantidad" type="text" value="<?php echo $v['cantidad']?> " maxlength="3" size="2" id="cantidad" class="TIE_cajaTexto3" onKeyPress="javascript:return validarNro(event)"></td>
