...
<style type="text/css">
.tablacarritocompras{width:100%;float:left;margin-left:1px;margin-top:8px;}
* html .tablacarritocompras{margin-left:13px;}
.body_tablacarritocompras{width:100%;float:left;background-color:#e9e9e9;}
.bg_buttom_carritocompras{width:100%;height:5px;float:left;background-image:url(/images/0/14/bg_bottom_tabla.gif);background-repeat:no-repeat;line-height:1px;margin:0px;}
.items_tablacarritocompras{margin:0;padding:0;border:0;outline:0;font-size:100%;vertical-align:baseline;background:transparent;border-collapse:collapse;border-spacing:0;width:100%;float:left;margin:0px;text-align:center;font-size:11px;}
.titulotablacarritocompras{width:100%;float:left;min-height:29px;background-color:#850929;background-image:url(/modulos/tienda_virtual/imagen/bg_header_tabla.gif);background-repeat:no-repeat; text-align:center;}

/* Inicio Titulos carrito*/
.titulotablacarritocompras .item_titu{margin:0px;padding:0px;width:6%;float:left;padding-top:8px;padding-bottom:8px;line-height:14px;}
.titulotablacarritocompras .categoria_titu{margin:0px;padding:8px 0px;width:10%;float:left;}
.titulotablacarritocompras .producto_titu{margin:0px;padding:8px 0px;width:30%;float:left;}
.titulotablacarritocompras .precio_titu{margin:0px;padding:8px 0px;width:10%;float:left;}
.titulotablacarritocompras .cantidad_titu{margin:0px;padding:8px 0px;width:10%;float:left;}
.titulotablacarritocompras .subtotal_titu{margin:0px;padding:8px 0px;width:10%;float:left;}
.titulotablacarritocompras .borrar_titu{margin:0px;padding:8px 0px;width:10%;float:left;}
/* Fin Titulos carrito*/
...
.items_tablacarritocompras .item_tabla{width:6%;vertical-align:middle;padding-top:8px;padding-bottom:8px;line-height:14px;border-right:#d7d7d7 solid 1px;border-bottom:#d7d7d7 solid 1px;overflow:hidden;background:#f1f1f1;}
.items_tablacarritocompras .categoria_tabla{width:10%;vertical-align:middle;padding-top:8px;padding-bottom:8px;border-right:#d7d7d7 solid 1px;border-bottom:#d7d7d7 solid 1px;overflow:hidden;background:#f1f1f1;color:#9e0c32;}
.items_tablacarritocompras .producto_tabla{width:30%;vertical-align:middle;padding-top:8px;padding-bottom:8px;border-right:#d7d7d7 solid 1px;border-bottom:#d7d7d7 solid 1px;overflow:hidden;background:#f1f1f1;}
.items_tablacarritocompras .precio_tabla{width:10%;vertical-align:middle;padding-top:8px;padding-bottom:8px;border-right:#d7d7d7 solid 1px;border-bottom:#d7d7d7 solid 1px;overflow:hidden;background:#f1f1f1;}
.items_tablacarritocompras .cantidad_tabla{width:10%;vertical-align:middle;padding-top:8px;padding-bottom:8px;border-right:#d7d7d7 solid 1px;border-bottom:#d7d7d7 solid 1px;overflow:hidden;background:#f1f1f1;}
.items_tablacarritocompras .subtotal_tabla{width:10%;vertical-align:middle;padding-top:8px;padding-bottom:8px;border-right:#d7d7d7 solid 1px;border-bottom:#d7d7d7 solid 1px;overflow:hidden;background:#f1f1f1;}
.items_tablacarritocompras .borrar_tabla{width:10%;vertical-align:middle;padding-top:8px;padding-bottom:8px;border-bottom:#d7d7d7 solid 1px;overflow:hidden;background:#f1f1f1;}
/* Fin detalle carrito*/
