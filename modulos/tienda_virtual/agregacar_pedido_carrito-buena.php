...
$carro[md5($id)]=array('identificador'=>md5($id),'cantidad'=>$cantidad,'producto'=>$row['cnomcontenido'],'nomproducto'=>$row['cnomcontenido'],'precio'=>$row['precio'],'rutaimagen'=>$row['cimgcontenido'],'id'=>$id);
