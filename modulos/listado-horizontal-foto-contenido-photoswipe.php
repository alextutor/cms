...
<?php 
$sql_query = "SELECT * FROM  foto_contenido fc WHERE  fc.ccodcontenido='".$codcont ."'";
...
{ 
	if($row['curlcontenido']=="") //Falta Implementar
	{
...
?>
    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
      <a href="<?=ereg_replace('fotos','thumbs',$row['url_foto'])?>" itemprop="contentUrl" data-size="400x300">
          <img src="/timthumb.php?src=<?=$row['url_foto'] ?>&h=140&w=200&zc=0&q=100&s=1" itemprop="thumbnail" 
          alt="<?=$row['cnomcontenido']?>" />
      </a>
