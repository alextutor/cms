...
?>
    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
      <a href="<?=ereg_replace('fotos','thumbs',$row['cimgcontenido'])?>" itemprop="contentUrl" data-size="400x300">
          <img src="/timthumb.php?src=<?=$row['cimgcontenido'] ?>&h=140&w=160&zc=0&q=100&s=1" itemprop="thumbnail" alt="<?=$row['cnomcontenido']?>" />
      </a>
