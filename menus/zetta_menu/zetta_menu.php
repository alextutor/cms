 <?php
	...
	//La tabla seccionmenu es el detalle de seccion y pagemenu
	...
	//esta sql esta en la carpeta vista archivo vmenu
	//echo $sqlmenucab;exit;
...
<!---------------- Inicio Estilo Menu multidrop  ---------------------->
  <?php 
  //echo $rowmenucab['multidrop'];exit;
  switch ($rowmenucab['multidrop']) {
	  case "Z2": //Menu1-Multidrop
	  	 ?>
          <!-- 1 Nivel multidrop -->
          <li class="zm-left-align">        
            ...
            <div class="zm-multi-column w-600">            
             <ul class="w-300">		<!-- Inicio Ul-1 2do menu multidrop  w-170-->					
              <?php  
