	  ...
	  case "4" &&  "1": // Duramenu-Categorias
          ...
          <li class="dropdown">
			...
			while ($rowmenucab2 = db_fetch_array($resmenucab2)) //Inicio while 2
			{
              ...
              <!-- alex le puse asi para que haya 2 contenedores de diferente tamaño        --> 
			   <?php 	
			   //echo $rowmenucab['cnomseccion']."FFFFFFFFFFFFFFFFF"	;	  
               if($rowmenucab['cnomseccion']="Por Marca de Vehiculo")
				{			
				?>
					<div class="container-fluid dropdown-menu-shopping">	
				<?php	
			    }	
				if($rowmenucab['cnomseccion']="Por Marca de Motor")
				{					
				?>                	
