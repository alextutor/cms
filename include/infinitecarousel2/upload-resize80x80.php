...
if (!isset($_GET['subpage'])) {   // Image Upload Form Below   ?>
  <form method="post" action="upload-resize80x80.php?subpage=upload" enctype="multipart/form-data">
   File:<br />
  ...
  if ($_FILES['imagefile']['type'] == "image/jpg" || $_FILES['imagefile']['type'] == "image/jpeg" || $_FILES['imagefile']['type'] == "image/pjpeg") {
    ...
    if ($copy) {   // If The Script Was Able To Copy The Image To It's Permanent Location
	  ...
	  echo $dimg .'<br>';
  	  echo $tdir.'<br>';
  	  echo $url.'<br>';
	  echo "<a href='http://www.infodisfap.com/FormInsertarColaborador.php?imagen80x80=$url&imagen=$url'>volver</a>";
