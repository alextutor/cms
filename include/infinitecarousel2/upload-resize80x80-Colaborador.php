...
$idir = "/home/info/public_html/noticia/imagen/80-80/colaborador/";   // Path To Images Directory
$tdir = "/home/info/public_html/noticia/imagen/80-80/colaborador/";   // Path To Thumbnails Directory
...
if (!isset($_GET['subpage'])) {   // Image Upload Form Below   ?>
  <form method="post" action="principal.php?pagina=/infinitecarousel2/upload-resize80x80-Colaborador&subpage=upload&Registro=<?php echo $Registro?>&paginacion=<?php echo $paginacion?>" enctype="multipart/form-data">
   File:<br />
  ...
  if ($_FILES['imagefile']['type'] == "image/jpg" || $_FILES['imagefile']['type'] == "image/jpeg" || $_FILES['imagefile']['type'] == "image/pjpeg") {
    ...
    if ($copy) {   // If The Script Was Able To Copy The Image To It's Permanent Location
	  ...
	  echo $dimg .'<br>';
  	  echo $tdir.'<br>';
  	  echo $url.'<br>';
	  echo "<a href='http://www.infodisfap.com/principal.php?pagina=FormActualizaColaborador&imagen80x80=$url&imagen=$url&Registro=$Registro&paginacion=$paginacion'>volver</a>";
