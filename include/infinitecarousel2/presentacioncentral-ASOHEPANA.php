<?php
  include($_SERVER['DOCUMENT_ROOT'].'/Asociaciones/ASOHEPANA/redireciona_facebook.php');  
  include_once($_SERVER['DOCUMENT_ROOT'].'/rutinas/conexioninfodisfap.php');
	$getNews_sql = 'SELECT *  FROM NEWS  WHERE ASOHEPANA=1 order by fechanoticia desc LIMIT 5';
