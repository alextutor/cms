...
$idir = "/home/info/public_html/noticia/imagen/80-80/DoctorResponde/";   // Path To Images Directory
$tdir = "/home/info/public_html/noticia/imagen/80-80/DoctorResponde/";   // Path To Thumbnails Directory
$twidth = "80";   // Maximum Width For Thumbnail Images
$theight = "80";   // Maximum Height For Thumbnail Images

if (!isset($_GET['subpage'])) {   // Image Upload Form Below   ?>
  <form method="post" action="principal.php?pagina=/infinitecarousel2/upload-resize80x80-DoctorResponde&subpage=upload&Registro=<?php echo $Registro?>&paginacion=<?php echo $paginacion?>" enctype="multipart/form-data">
   File:<br />
  <input type="file" name="imagefile" class="form">
  <br /><br />
  <input name="submit" type="submit" value="Sumbit" class="form">  <input type="reset" value="Clear" class="form">
  <input name="Registro"  type="hidden"  id="Registro" value="<? echo $Registro; ?>" size="70" />
  <input name="paginacion"  type="hidden"  id="paginacion" value="<? echo $paginacion; ?>" size="70" />
  </form>
<p>
  ...
  if ($_FILES['imagefile']['type'] == "image/jpg" || $_FILES['imagefile']['type'] == "image/jpeg" || $_FILES['imagefile']['type'] == "image/pjpeg") {
    ...
    if ($copy) {   // If The Script Was Able To Copy The Image To It's Permanent Location
	  ...
	  echo $dimg .'<br>';
  	  echo $tdir.'<br>';
  	  echo $url.'<br>';
	  echo "<a href='http://www.infodisfap.com/principal.php?pagina=FormActualizaDoctor-Responde&imagen80x80=$url&imagen=$url&Registro=$Registro&paginacion=$paginacion'>volver</a>";
