...
$tdir = "/home/info/public_html/noticia/imagen/108-96/";   // Path To Thumbnails Directory
$twidth = "108";   // Maximum Width For Thumbnail Images
$theight = "96";   // Maximum Height For Thumbnail Images

if (!isset($_GET['subpage'])) {   // Image Upload Form Below   ?>
  <form method="post" action="upload-resize108x96.php?subpage=upload" enctype="multipart/form-data">
   File:<br />
  ...
  if ($_FILES['imagefile']['type'] == "image/jpg" || $_FILES['imagefile']['type'] == "image/jpeg" || $_FILES['imagefile']['type'] == "image/pjpeg") {
    ...
    if ($copy) {   // If The Script Was Able To Copy The Image To It's Permanent Location
	  ...
	  echo $dimg .'<br>';
  	  echo $tdir.'<br>';
  	  echo $url.'<br>';
	  echo "<a href='http://www.infodisfap.com/FormInsertarNoticia.php?imagen108x96=$url&imagen=$url'>volver</a>";
