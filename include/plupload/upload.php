...
$alexruta='/imagen/'.$_SESSION['cRuta_Foto_Contenido'].'/foto-contenido/';
...
if (!$chunks || $chunk == $chunks - 1) {
	...
	// ------------------------ Inicio Alex -----------------------------
	 ...
	 //include($_SERVER['DOCUMENT_ROOT']. '/config.php'); //mpvido arriba para saber 		
	 extract($_POST);
	 $ccodcontenido=$_GET['ccodcontenido'];
	 $save_contenido= "INSERT INTO foto_contenido 
						(
						ccodcontenido,
						ccodpage,
						url_foto,
