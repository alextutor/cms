<style type="text/css">	
	...
	.comen_post .titulo_post {float:left; width:60%; color:#990048;font-weight: bold;}
...
<?php 
$resultComen = "SELECT * FROM doctorresponde WHERE mostrarportada=1 and parent_id=0 and aceptado=1 ORDER BY id desc   LIMIT 15 ";
