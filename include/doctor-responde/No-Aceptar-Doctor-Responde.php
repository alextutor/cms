...
//Creamos la sentencia SQL y la ejecutamos
	$result = mysql_query("UPDATE doctorresponde SET aceptado=0 WHERE id=".$Registro) ;  	
 ...
 if ($email != "") {  // -------inicio Si 3 
	 ...
	 Gracias Por su Consulta y/o Respuesta ha sido Analizada y NO Fue Aceptada.<br><br>   
	...
	# Función de envío del mensaje  
	 mail("$person_email","Gracias Por su Consulta y/o Respuesta-NO ACEPTADA","$mensaje","$header");  
	 # Ten en cuenta que:  
...
<script language="javascript">
    location.href = 'mantDoctor-Responde-Admi.php?mensaje=Registro NO Aceptado&paginacion='+ <?php echo  $paginacion ?> ;
</SCRIPT>