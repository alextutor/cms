...
<body >
<br><br><font color="#FF0000"> <strong>Nota Importante</strong></font> <strong>SEGURO DE VIDA </strong><br>Quiero advertir que abogados inescrupulosos y personas  tinterillas estan aprovechandose de incautos colegas discapacitados o viudas  que tramitan su <strong>SEGURO DE VIDA</strong>,<strong>Cobrandoles la mitad o casi todo el Seguro </strong>, decirles que este tramite <strong>NO necesita de  abogado</strong>, y su tramite es puntual, si le corresponde no sera necesario ni  coimear y viene de Puro derecho, pero si quieren hacer al margen de la  ley....no recurren a malos profesionales...mucho cuidado. atte <strong>cesar</strong> <br><br>
...
<TR>
  ...
  <CENTER>
    ...
    <a href='principal.php?pagina=doctor-responde/FormConsulta&idcate=0&idsubcate=0&procedencia=DoctorResponde&PaginaDestino=doctor-responde/index&ConsultaRespuesta=AgregarConsulta'> <img src="doctor-responde/imagen/Nuevo-Tema-naranja.gif" width="98"  border="0" height="25"></a>   
    </p>
...
<?php 		//include($_SERVER['DOCUMENT_ROOT'].'/rutinas/cerrar_conexion.php'); 
?>
