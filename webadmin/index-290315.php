		...
		<div id="element-box" class="login">
             ...
             <div id="section-box">
                <div class="m">
                  ...
                  <p style="font-size:12px;font-weight:bold; color:#F00"><a style="color: #F00" href="<?php $_SERVER['DOCUMENT_ROOT']?>/index.php">Ir a la p&aacute;gina de inicio del sitio.</a></p>
                  <div id="lock"></div>
              </div>
            </div>
      <?php  			  
