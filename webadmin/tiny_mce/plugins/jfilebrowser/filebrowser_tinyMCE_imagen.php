 ...
 */
//NO OLVIDES DE LEER EL ARCHIVO instalar.txt
...
if(isset($_GET['set_cook'])){$set_cook =$_GET['set_c'];}
...
//incluir la idsec1 de validacion solo cuando es necesario
  ...
  <tr>
	...
	$totalRows_rs_producto2 = mysql_num_rows($rs_producto2);
	  ...
	  if($totalRows_rs_producto2 < 1) {?>
	    ...
	    <form class="centrar" method="post" action="" onsubmit="jFileBrowserDialog.insert_cuadro_imagen('<?php echo $ruta_completa_ar ?>', <?php echo $tipo_arch ?>, '<?php echo $nombre_ar; ?>');return false;">
...
<form onsubmit="jFileBrowserDialog.insert_cuadro_imagen ();return false;" action="#">
