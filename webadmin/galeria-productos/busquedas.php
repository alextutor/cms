  ...
  .cong_busque {
   ...
   .cong_lista {
	...
	.fondocate .cabecera {	
		...
		height: 20px; /* h4 ver line-height*/
		margin: 0 auto;
		width: auto;
	}
	.fondocate h4 {
	  ...
	  font-size: 16px;
	  font-weight: 100;
	  line-height: 20px; /* cabecera ver height*/
	  margin: 0;
	  text-align: center;
...
$consulta="select * from subcategoria where idcategoria=".$CateId." and estado=1" ;
	  ...
	  while( ($fila=mysql_fetch_array($datos)) ) { //al terminar while el puntero esta en el ultimo registro						
		...
		?>
          <div  class=fondocate>
             ...
             <div class="imagen"> 					
                <a rel="shadowbox[galeria1]" href="<?php echo $imagen ?>">						
         <img src='timthumb.php?src=<?php echo $imagen ?>&h=160&w=130&zc=0&q=100&s=1' border=0 title="<?php echo $fila['titulo']?>" />	 
                 </a>	                                                 			                     											  
              </div>
          </div>
        <?php
