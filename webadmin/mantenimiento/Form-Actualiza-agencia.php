...
<?php
$sqlp    = db_query("SELECT * FROM pagesucursal WHERE ccodsucursal = '". $_GET['id'] ."'");
...
<div id="toolbar-box">
	<div class="m">
        <div class="toolbar-list" id="toolbar">
          ...
          <a href="/webadmin/index.php?option=com_agencia" onClick="Joomla.submitbutton('article.cancel')" class="toolbar"><span class="icon-32-cancel"></span>Cancelar</a>
            </li>            
            </ul>
         </div>
         <div class="pagetitle icon-48-article-add">
           <h2>Gestor de Agencias: Actualiza  Agencia</h2></div></div><div id="element-box">
		<div class="m">
        	<!--Inicio Formulario -->
            <form action="/webadmin/mantenimiento/Actualiza-Agencia.php" method="post" name="adminForm" id="adminForm" class="form-validate"
				...
				<legend>Detalles</legend>
					<ul class="adminformlist">	
                      ...
                      ?>
                        ...
                        <input type="text" name="titulo"  size="85" maxlength="150" value="<?=$rowp['cnomsucursal']?>">
                        </li>                        
                                        
                                                
                        <li><label id="jform_title-lbl" for="jform_title" class="hasTip" title="">Orden <span class="star">&nbsp;*</span></label>
                        <input type="text" name="orden" id="orden" value="<?=$rowp['orden']?>" class="inputbox" size="40" aria-required="true" required></li>                
                       ...
                       <input name="direccion" type="text" value="<?=$rowp['cdiroficina']?>"  size="85" maxlength="150" >
                       </li>
                        <li>
                    <label id="jform_published-lbl" for="jform_published" class="hasTip" title="" aria-invalid="false">Codigo Google Map</label>	
                      <textarea name="cod_google_map" cols="100%" rows="15" id="cod_google_map"><?=$rowp['cod_google_map']?>
                      </textarea></li>
                      <li><label id="mostrar_lbl" for="mostrar" class="hasTip" title="">Ancho Mapa</label>	
                       <input name="anchomapa" type="text" value="<?=$rowp['anchomapa']?>"  size="10" maxlength="10" >
                       px</li>                      
                      <li><label id="mostrar_lbl" for="mostrar" class="hasTip" title="">Alto Mapa</label>	
                       <input name="altomapa" type="text" value="<?=$rowp['altomapa']?>"  size="10" maxlength="10" >
                       px</li>                      
               ...
               <fieldset class="panelform">
                	<ul class="adminformlist">	
                        ...
                        <label id="jform_published-lbl" for="jform_published" class="hasTip" title="" aria-invalid="false">Telefono Fijo</label>	
                         <input name="tfijo" type="text" value="<?=$rowp['ctelsucursal']?>"  size="30" maxlength="15" >
                        </li> 
                         <li>
                   <label id="jform_published-lbl" for="jform_published" class="hasTip" title="" aria-invalid="false">Fax</label>	
                   <input name="tfax" type="text" value="<?=$rowp['cfaxsucursal']?>"  size="30" maxlength="15" >
                         </li>
                         <li>
                  <label id="jform_published-lbl" for="jform_published" class="hasTip" title="" aria-invalid="false">Movil</label>	                   <input name="tmovil" type="text" value="<?=$rowp['cmovsucursal']?>"  size="30" maxlength="15" >
                         </li>
                         <li>
                  <label id="jform_published-lbl" for="jform_published" class="hasTip" title="" aria-invalid="false">Nextel</label>	                   <input name="nextel" type="text" value="<?=$rowp['cnexsucursal']?>"  size="30" maxlength="15" >
                         </li>
                          <li>
                  <label id="jform_published-lbl" for="jform_published" class="hasTip" title="" aria-invalid="false">Horario de atención<br>
                  </label>
                  <textarea name="horario_atencion" cols="80px" rows="5" id="horario_atencion"><?=$rowp['horario_atencion']?>
                  </textarea>
                         </li>
                      <li>
                  ...
                  <select name="localprincipal" id="localprincipal">
                    ...
                    <option value="no">NO</option>
                          ...
                          <li>
                  <label id="jform_published-lbl" for="jform_published" class="hasTip" title="" aria-invalid="false">Email</label>	                   <input name="email" type="text" value="<?=$rowp['cemasucursal']?>"  size="40" >
                         </li>
                         <li>
                 <label id="jform_published-lbl" for="jform_published" class="hasTip" title="" aria-invalid="false">Pagina Web</label>	                
                 <input name="web" type="text" value="<?=$rowp['curlsucursal']?>"  size="40" >
                         </li>         
                    </ul>
               </fieldset>	    
    </div></div> 
