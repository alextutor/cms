<?php
	...
	$sql="SELECT * FROM cursos ".$criterio; 	
	$res=mysql_query($sql); 
  ...
  if(!isset($orden)) 
	...
	$sql="select * from cursos,page where cursos.ccodpage=page.ccodpage and cursos.estado=1";  
	 
	$columnas[] = 'codigo_curso';
	$columnas[] = 'curso';
	$columnas[] = 'duracion_curso';	
	$columnas[] = 'inicioclases_curso';
	$columnas[] = 'modalidad_curso';		
	$columnas[] = 'detalle_curso';
	$columnas[] = 'estado';	
...
<div id="toolbar-box">
	<div class="m">
    	<div class="toolbar-list" id="toolbar">
            ...
            <a href="/webadmin/index.php?option=com_cursos_new" onclick="" class="toolbar"><span class="icon-32-new"></span>Nuevo</a>
            </li>
         ...
         <div class="pagetitle icon-48-article">
           <h2>Gestor de Cursos: Cursos</h2></div>            
    </div>
</div>
...
while($registro=mysql_fetch_array($res)) {
 ...
 ?> 
	<tr class="row0">	
    <td class="center">
     <input type="checkbox" id="cb0" name="cid[]" value="<?php echo $registro['id_curso'];?>" onclick="Joomla.isChecked(this.checked);" title="Casilla de selección para la fila 1">										
     </td>                      
 <?php 	
	//$x=0;			   
	//foreach($columnas as $CampoProducto){
