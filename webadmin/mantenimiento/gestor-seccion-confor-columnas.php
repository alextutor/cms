...
<div id="toolbar-box">
	<div class="m">
    	<div class="toolbar-list" id="toolbar">
            ...
            document.forms['adminForm'].task.value='com_seccion_editar',
         ...
         <div class="pagetitle icon-48-article">
           <h2>Gestor de Seccion: Seccion</h2></div>            
    </div>
</div>
...
<?php 
 ...
 ?> 
	<tr class="row0">	
    <td class="center">
     <input type="checkbox" id="cb0" name="cid[]" value="<?php echo $registro['ccodseccion'];?>" onclick="Joomla.isChecked(this.checked);" title="Casilla de selección para la fila 1">										
     </td>                      
 <?php 	
	//$x=0;			   
	//foreach($columnas as $CampoProducto){
	 ...
	 foreach($columnas as $CampoProducto){   
		if ($CampoProducto=="imagen") {
		 ...
		 echo "<td width='".$nAncho[$x]."'>". "<img src='timthumb.php?src=" .$imagen. "&h=80&w=80&zc=0&q=100&s=1' border=0 class='mgredondearesq'/>" ."</td>"; 
		  ...
		  echo "<td width='".$nAncho[$x]."'>". $espacio . $registro[$CampoProducto] ."</td>";		
		} 
		$x++;								
	}									
