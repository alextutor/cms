<?php
	...
	$sql="SELECT * FROM pagehome ".$criterio; 	
	$res=mysql_query($sql); 
  ...
  if(!isset($orden)) 
	...
	$sql="SELECT p.cnomhome,p.cordpublica, p.cubidestino,p.nancho+p.nalto as tamano,
	 wp.cnomparametro as tipo_contenido from pagehome p , webparametros wp where p.estado='1' and 
	  wp.ccodparametro='0014' and wp.ctipparametro='1'";   	 
