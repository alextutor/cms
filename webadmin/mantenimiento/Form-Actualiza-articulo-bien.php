	...
	<div class="m">
        <div class="toolbar-list" id="toolbar">
         ...
         <div class="pagetitle icon-48-article-add">
           <h2>Gestor de art&iacute;culos: Actualiza un  art&iacute;culo</h2></div>
    </div>
    <div id="element-box">
		<div class="m">
        	<!--Inicio Formulario -->                        
       ...
       <?php $sContent = $row_contenido['crescontenido']; ?>
...
<script>
		...
		oEdit1.REPLACE("contenido");//Specify the id of the textarea here
            ...
            <select id="estado" name="estado" class="inputbox" size="1" aria-invalid="false">
                ...
                <option value="4" <?php if( $row_contenido['estado']=="4") echo " selected='selected'"  ?>>Movido a la papelera</option>                     
                        ...
                        <li><label id="jform_published-lbl" for="jform_published" class="hasTip" title="" aria-invalid="false">Descripci&oacute;n</label>	
                   
                   <?php $sContent = $row_contenido['cdetcontenido']; ?>
                    <textarea id="contenidosss" name="contenidosss" >                 
                    </textarea>
                   </li>                      
        ...
        <!--Fin grupo1 -->            
                <!-------------------------------------------------->
       <div class="panel"><h3 id="bobcontent2-title" class="handcursor">Opciones de Im&aacute;genes</h3> 
  <div id="bobcontent2" class="switchgroup1" style="padding-top: 0px; border-top-style: none; padding-bottom: 0px; border-bottom-style: none; overflow: hidden; height: auto;" >            
               <fieldset class="panelform">
                	<ul class="adminformlist">	
	                    <li><label id="jform_published-lbl" for="jform_published" class="hasTip" title="" aria-invalid="false">Estilo de Presentaci&oacute;n del Contenido</label>	
  ...
  <div id="bobcontent4" class="switchgroup1" style="padding-top: 0px; border-top-style: none; padding-bottom: 0px; border-bottom-style: none; overflow: hidden; height: auto;" >            
               <fieldset class="panelform">
                	<ul class="adminformlist">	
                       ...
                       <li><label id="duracion_lbl" for="duracion" class="hasTip" title="">Duraci&oacute;n</label>	
            ...
            <input type="submit" name="enviar" value="Enviar" 
             onclick="document.getElementById('descripcion').value = oEdit1.getHTMLBody(); "/>                 
