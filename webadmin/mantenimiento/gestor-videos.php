...
<div id="toolbar-box">
	<div class="m">
    	<div class="toolbar-list" id="toolbar">
            ...
            <a href="/webadmin/index.php?option=com_videos_new" onclick="" class="toolbar"><span class="icon-32-new"></span>Nuevo</a>
            </li>
  ...
  <h2>Gestor de Videos: Videos</h2></div></div></div><div id="system-message-container">
	<?php 
		if($mensaje!="") { 
		?>
...
?> 
	<tr class="row0">	
        <td class="center">
         ...
         <td width="<?=$nAncho[$x]?>">
		 <a href='/webadmin/index.php?option=com_videos_editar&id=<?=$registro['ccodcontenido']?>'>
		 <?=$registro['cnomcontenido']?></a>
         </td>                             
         <td width="<?=$nAncho[$x]?>"><?=$registro['url_video']?></td> 
         <td width="<?=$nAncho[$x]?>"><?=$registro['estado']?></td> 
         <td width="<?=$nAncho[$x]?>"><?=$registro['cnomseccion']?></td>
         <td width="<?=$nAncho[$x]?>"><?=$registro['cordcontenido']?></td>
