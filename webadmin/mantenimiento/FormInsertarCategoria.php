...
<div id="toolbar-box">
    ...
    <div id="element-box">
		<div class="m">
        	<!--Inicio Formulario -->
            <form action="/webadmin/mantenimiento/Insertar-categoria.php" method="post" name="adminForm" id="item-form" class="form-validate">
               ...
               <fieldset class="adminform">
				<legend>Detalles</legend>
					<ul class="adminformlist">	
                        ...
                        <input type="text" name="titu_cate" id="titu_cate" value="" class="inputbox required" size="40" aria-required="true" required="required"></li>
           		...
           		<div id="categories-sliders-" class="pane-sliders">
                	<ul class="adminformlist">	
                	 <li><label id="jform_published-lbl" for="jform_published" class="hasTip" title="" aria-invalid="false">Imagen</label>	
                     	<div><textarea name="img_cate" id="img_cate"></textarea></div>
                     </li>
                    </ul>    
                </div>
           </div>
