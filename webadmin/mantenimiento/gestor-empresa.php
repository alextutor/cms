...
else
{
	...
	include($_SERVER['DOCUMENT_ROOT']. '/config.php');		
		...
		$sql = "SELECT * FROM page order by cnompage desc";
	...
	<div class="m">
    	<div class="toolbar-list" id="toolbar">
         ...
         <div class="pagetitle icon-48-article">
           <h2>Gestor de Empresa: Empresa</h2></div></div></div><div id="system-message-container">
	<?php 
		if($mensaje!="") { 
		?>
...
?> 
	<tr class="row0">	
        <td class="center">
         ...
         <td width="<?=$nAncho[$x]?>">
		 <a href='/webadmin/index.php?option=com_empresa_editar&id=<?=$registro['ccodpage']?>'><?=$registro['cnikpage']?></a>
         </td>                             
         <td width="<?=$nAncho[$x]?>"><?=$registro['camipage']?></td> 
         <td width="<?=$nAncho[$x]?>"><?=$registro['cemacontacto']?></td>                             
	</tr>   
<?php 
	}//fin while 
?>
