...
<div id="toolbar-box">
	<div class="m">
        <div class="toolbar-list" id="toolbar">
          ...
          <a href="/webadmin/index.php?option=com_elementos_pie" onclick="Joomla.submitbutton('article.cancel')" class="toolbar"><span class="icon-32-cancel"></span>Cancelar</a>
            </li>            
            </ul>
         </div>
         <div class="pagetitle icon-48-category-add icon-48-content-category-add">
           <h2>Gestor de Elementos Pie: Añadir un Elemento Pie</h2></div>
    </div>
    <div id="element-box">
		<div class="m">
        	<!--Inicio Formulario -->
            <form action="/webadmin/mantenimiento/Insertar-elemento-pie.php" method="post" name="adminForm" id="item-form" class="form-validate">
				...
				<legend>Detalles</legend>
					<ul class="adminformlist">	
                        ...
                        <input type="text" name="orden" id="orden" value="" class="inputbox" size="40" aria-required="true" required="required"></li>
                          ...
                          <li><label id="jform_title-lbl" for="jform_title" class="hasTip" title="">Posicion <span class="star">&nbsp;*</span></label>
                        <input type="text" name="posicion" id="posicion" value="" class="inputbox" size="40" aria-required="true" required="required"></li>
