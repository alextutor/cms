					...
					while($row_seccion3 = db_fetch_array($seccion3_sql)) 
						{
							...
							$sqlselec4="SELECT ccodseccion, cnomseccion, cnivseccion FROM seccion WHERE ccodseccion like '".$niv3cod."%' and estado ='1' and cnivseccion='4' and (ctipseccion='1' or ctipseccion='3') order by cordcontenido";
							//echo $sqlselec4;exit;
