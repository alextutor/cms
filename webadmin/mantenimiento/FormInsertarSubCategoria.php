	...
	<div class="m">
        <div class="toolbar-list" id="toolbar">
         ...
         <div class="pagetitle icon-48-sub-category-add">
           <h2>Gestor de Sub-Categorías: Añadir una nueva Sub-Categoría de artículos</h2></div>
    </div>
    <div id="element-box">
		<div class="m">
        	<!--Inicio Formulario -->
            <form action="/webadmin/mantenimiento/Insertar-Sub-categoria.php" method="post" name="adminForm" id="item-form" class="form-validate">
