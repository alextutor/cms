...
<div id="toolbar-box">
	<div class="m">
    	<div class="pagetitle icon-48-article">
           <h2>Gestor de artículos: Artículos</h2>
         </div>
    	<div class="toolbar-list" id="toolbar">
            <ul>
             <li class="button" id="toolbar-new-desde-Excel">
            <a href="/webadmin/index.php?option=com_articulos_Excel_new" onclick="" class="toolbar"><span class="icon-32-new-excel"></span>Nuevo</a>
            </li> 
            <li class="divider" style="margin-left:60px;"></li>  
...
<div id="element-box">
	<div class="m">       
        ...
        <div class="lado_izquierda">
        	<?php include $_SERVER['DOCUMENT_ROOT']."/webadmin/mantenimiento/form_buscador.php";	?>              	
        </div>    
        <!---------------  Fin lado Izquierda ------------------->    
       ...
       <div class="lado_derecha">
	   	 <div id="listado">
			<?php include $_SERVER['DOCUMENT_ROOT']."/webadmin/mantenimiento/gestor_articulo_listado.php";	?>           
         </div>
