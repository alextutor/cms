...
function elFinderBrowser (field_name, url, type, win) {
  tinymce.activeEditor.windowManager.open({
    file: '/webadmin/tiny_mce/plugins/jfilebrowser/filebrowser.php',// use an absolute path!
    ...
    setUrl: function (url) {
      win.document.getElementById(field_name).value = url;
  	  ...
  	  win.document.forms[0].elements[field_name].value = ruta_completa_ar;
  return false;

}	//fin function elFinderBrowser
</script>
