...
<?php    
  ...
  $save_contenido= "UPDATE contenido 	SET
	...
	$sqlsec = db_query("SELECT ccodseccion, cnomseccion, cnivseccion FROM seccion WHERE ccodpage= '".$selectpage."' and cestseccion ='1' and ccodmodulo='1100'or ccodmodulo='1200' or ccodmodulo='1300' and ctipseccion='1' order by ccodseccion");	
