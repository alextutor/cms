<?php session_start(); 
  ...
  if(!isset($orden)) 
	...
	$sql="SELECT  productos.*,subcate.titulo as subcategoria,cate.titu_cate as categoria 
	 FROM productos LEFT JOIN categoria cate ON (productos.idcategoria=cate.idcategoria) 
	 LEFT JOIN subcategoria subcate ON (productos.idsubcategoria=subcate.idsubcategoria) where productos.estado=1";  
	 
	$columnas[] = 'titulo';
	$columnas[] = 'categoria';
	$columnas[] = 'subcategoria';	
	$columnas[] = 'imagen';		
	$columnas[] = 'estado';
	$columnas[] = 'orden';	
...
<div id="toolbar-box">
	<div class="m">
    	<div class="toolbar-list" id="toolbar">
            ...
            <a href="/webadmin/index.php?option=com_articulos_new" onclick="" class="toolbar"><span class="icon-32-new"></span>Nuevo</a>
            </li>
         ...
         <div class="pagetitle icon-48-article">
           <h2>Gestor de artículos: Artículos</h2></div>            
    </div>
</div>
...
while($registro=mysql_fetch_array($res)) {
 ...
 ?> 
	<tr class="row0">	
    <td class="center">
     <input type="checkbox" id="cb0" name="cid[]" value="<?php echo $registro['idproductos'];?>" onclick="Joomla.isChecked(this.checked);" title="Casilla de selección para la fila 1">										
     </td>                      
 <?php 	
	//$x=0;			   
	//foreach($columnas as $CampoProducto){
