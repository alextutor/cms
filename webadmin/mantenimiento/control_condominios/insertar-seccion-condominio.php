...
$save_contenido= "INSERT INTO condominio_secciones 
						(
						idcondominio,
						nombreseccion,
						observacion,
	...
	$sqlcontenido =mysql_query($save_contenido,$conexion) or die ("problema con Insertar Seccion Condominio");		
...
<script language='JavaScript'>    
	ROOT_PATH = "<?=$ROOT_PATH?>";
	location.href= ROOT_PATH+ '/webadmin/index.php?option=com_gestor_secciones_condominio&mensaje=La Seccion Condominio ha sido Ingresada correctamente' 
</script> 
