...
<div id="toolbar-box">
	<div class="m">
        <div class="toolbar-list" id="toolbar">
          ...
          <a href="/webadmin/index.php?option=com_gestor_departamentos" onClick="Joomla.submitbutton('article.cancel')" class="toolbar"><span class="icon-32-cancel"></span>Cancelar</a>
            </li>            
            </ul>
         </div>
         <div class="pagetitle icon-48-category-add icon-48-content-category-add">
           <h2>Gestor de Departamento Condominio: Nuevo Departamento</h2></div>
    </div>
    <div id="element-box">
		<div class="m">
        	<!--Inicio Formulario -->
	   ...
	   <ul class="adminformlist">	
           ...
           <label id="jform_title-lbl" for="jform_title" class="hasTip required" title="">Seccion Condominio <span class="star">&nbsp;*</span></label>
            <select id="idseccion" name="idseccion" class="inputbox" size="1" aria-invalid="false"> 
					 <?php 
                     $rsesweb = db_query("select * from condominio_secciones");
                    while($rowesweb = db_fetch_array($rsesweb)) {	                                 													 				
					   echo '<option value="'.$rowesweb['idseccion'].'">'.$rowesweb['nombreseccion'].'</option>';		 
                        }//fin while						
                     ?>                                 
            </select>
           </li>
          ...
          <li>
          <label id="jform_title-lbl" for="jform_title" class="hasTip required" title="">Nombre o número de departamento<span class="star">&nbsp;*</span></label>
          <input type="text" name="nombredepa" id="nombredepa" value="" class="inputbox required" size="40" aria-required="true" required style="text-transform:UPPERCASE" >
          </li>
          <li>
           ...
           <div class="width-40 fltrt">
           		<div id="categories-sliders-" class="pane-sliders">
                	<ul class="adminformlist">	<br>
                       <!----------------- Lado Derecha -----------------------------> 
                       <center>
                    <img src="<?php echo "/webadmin/mantenimiento/control_condominios/"?>imagen/casita.jpg" 
                     width="216" height="179">                    
                       </center>
                    </ul>    
                </div>
           </div>
