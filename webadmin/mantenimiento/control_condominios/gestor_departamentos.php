...
<div id="toolbar-box">
	<div class="m">
    	<div class="pagetitle icon-48-article">
           <h2>Gestor de Departamentos: Departamento.</h2>
         </div>
    	<div class="toolbar-list" id="toolbar">
            <ul>       
            
            <li class="button" id="toolbar-new">
            <a href="/webadmin/index.php?option=com_departamento_new" onclick="" class="toolbar"><span class="icon-32-new"></span>Nuevo</a>
            </li>           
...
<div id="element-box">
	<div class="m">       
       ...
       <div class="lado_derecha">
	   	 <div id="listado">
			<?php include $_SERVER['DOCUMENT_ROOT']."/webadmin/mantenimiento/control_condominios/gestor_departamento_listado.php";	?>           
         </div>
