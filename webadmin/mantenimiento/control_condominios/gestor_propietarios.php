...
<div id="toolbar-box">
	<div class="m">
    	<div class="pagetitle icon-48-article">
           <h2>Gestor de Propietarios: Propietarios</h2>
         </div>
    	<div class="toolbar-list" id="toolbar">
            <ul>       
            
            <li class="button" id="toolbar-new">
            <a href="/webadmin/index.php?option=com_propietario_new" onclick="" class="toolbar"><span class="icon-32-new"></span>Nuevo</a>
            </li>           
...
<div id="element-box">
	<div class="m">       
        ...
        <div class="lado_izquierda">
        	<?php include $_SERVER['DOCUMENT_ROOT']."/webadmin/mantenimiento/control_condominios/form_buscador_propietarios.php";	?>              	
        </div>    
        <!---------------  Fin lado Izquierda ------------------->    
       ...
       <div class="lado_derecha">
	   	 <div id="listado">
			<?php include $_SERVER['DOCUMENT_ROOT']."/webadmin/mantenimiento/control_condominios/gestor_maestro_residente_vivienda.php";	?>           
         </div>
...
<script>
	$(document).ready(function(){	
		...
		$("#buscar").click(function(){
		  $.post("/webadmin/mantenimiento/control_condominios/gestor_viviendapropietarios_listado.php",
		  {idbuscar:'1',idseccion:$("#selectseccion").val(),nombre:$("#nombre").val(),departamento:$("#departamento").val()},
			function(data){$("#listado").html(data);})
	    });	
	});	
</script>
