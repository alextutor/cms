...
<div id="toolbar-box">
	<div class="m">
    	<div class="pagetitle icon-48-article">
           <h2>Gestor de Secciones del Condominio:</h2>
               <div>
    Las secciones se refieren a Torres, Clusters, Sectores, Calles, etc.<br/><br/>
    La idea es diferenciar cada vivienda o unidad. Por ejemplo la vivienda número 101 puede repetirse en varias torres. Por ello necesitamos el nombre de cada sección que en este caso podrían ser Torre A, Torre B, Torre C ...<br/><br/>
    Si tu condominio sólo tiene una sección crea una llamada "General".<br/><br/>
              </div>
         </div>
    	<div class="toolbar-list" id="toolbar">
            ...
            <a href="/webadmin/index.php?option=com_seccion_condominio_new" onclick="" class="toolbar"><span class="icon-32-new"></span>Nuevo</a>
            </li>           
            ...
            document.forms['adminForm'].task.value='com_seccion_condominio_editar',
...
<div id="element-box">
	<div class="m">       
       ...
       <div class="lado_derecha">
	   	 <div id="listado">
			<?php include $_SERVER['DOCUMENT_ROOT']."/webadmin/mantenimiento/control_condominios/gestor_condominio_seccion_listado.php";	?>           
         </div>
