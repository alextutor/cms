...
<div id="toolbar-box">
	<div class="m">
        <div class="toolbar-list" id="toolbar">
          ...
          <a href="/webadmin/index.php?option=com_gestor_secciones_condominio" onClick="Joomla.submitbutton('article.cancel')" class="toolbar"><span class="icon-32-cancel"></span>Cancelar</a>
            </li>            
            </ul>
         </div>
         <div class="pagetitle icon-48-category-add icon-48-content-category-add">
           <h2>Gestor de Secciones del Condominio: Insertar Nueva Seccion</h2></div></div><div id="element-box">
		<div class="m">
        	<!--Inicio Formulario -->
            <form action="/webadmin/mantenimiento/control_condominios/insertar-seccion-condominio.php" method="post" name="adminForm" id="item-form" class="form-validate">
	   ...
	   <ul class="adminformlist">	
           ...
           <label id="jform_title-lbl" for="jform_title" class="hasTip required" title="">Condominio <span class="star">&nbsp;*</span></label>
            <select id="condominio" name="condominio" class="inputbox" size="1" aria-invalid="false"> 
					 <?php 
          ...
          <li>
          <label id="jform_title-lbl" for="jform_title" class="hasTip required" title="">Nombre de la Nueva Sección<span class="star">&nbsp;*</span></label>
          <input type="text" name="nombreseccion" id="nombreseccion" value="" class="inputbox required" size="40" aria-required="true" required style="text-transform:UPPERCASE" >
          </li>
          <li>
