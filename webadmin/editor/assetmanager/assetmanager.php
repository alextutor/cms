...
//echo $_SESSION['rutaimages']."----". $sBase0;exit;
/*** Permission ***/
$bReadOnly0=false;
$bReadOnly1=true;
$bReadOnly2=false;
...
if(isset($_FILES["File1"]))
  {
	...
	//ereg_replace cambiado por str_replace
	$nomimagen = str_replace('.'.$extimagen,'',$nomimagen1);
	$nvoimagen = str_replace("[^A-Za-z0-9]",'-',$nomimagen).".".$extimagen;

	//echo $_FILES['File1']['tmp_name']; exit;
//	echo $currFolder."/".$nvoimagen;exit;	
