...
if($tipocontenido == '1')
{
    ...
    <tr>
        ...
        <input type='text' name='imagen' id='imagen' size='70'  maxlength='150' class="box400">
        <input type="button" value="Seleccionar" onClick="openAsset('imagen')" id="btnAsset" name="btnAsset"style="height:30px;vertical-align:middle;" > 
        </td>
    </tr>
    <tr>
