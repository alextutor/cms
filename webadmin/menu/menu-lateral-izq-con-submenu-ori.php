...
<?php
 ...
 ?>  	    
          <li class="nivel1"> <!--Inicio de Menu Principal -->          
			<a href="index.php?aside=total&idsec1=/webadmin/galeria-productos/galeria&CateId=<?php echo trim($rsCategoria['idcategoria']);?>
            &descrprodu=<?php echo $rsCategoria['titulo'] ?>" class="nivel1">              
			<?php 
			//alex quite contador 
		...
		<?php
         	$subconsulta="select * from  subcategoria where estado=1 and idcategoria='" . $rsCategoria['idcategoria'] ."' order by orden asc";
			...
			// Inicio contar cuantos registros hay con esa subcategoria
				$consuprodusubcate="SELECT * from  productos where estado=1 and idcategoria=".$rsSubCategoria['idcategoria'] ." and  idsubcategoria=" . $rsSubCategoria['idsubcategoria'] ;
        ...
        ?>      
            <li>
            <a href="principal.php?idsec1=galeria-productos/busquedas&idcategoria=<?php echo $rsSubCategoria['idcategoria'];?>&idsudcategoria=<?php echo $rsSubCategoria['idsubcategoria'] ?>&descrprodu=<?php echo $rsSubCategoria['descripSubcategoria'] ?>">
			<?php echo htmlspecialchars($rsSubCategoria['descripSubcategoria']) . "&nbsp;&nbsp;". "(". $num_produsubcate .")" ?>
            </a>
            </li>         
