...
?>
<header id="cabecera">
  <div class="ctncabecera">
      <div class="ctnlogo">
   	    <img src="<?php echo $logoweb ?>"  alt="logo-gis" width="100%"  />	 
      </div>       
      <div class="ctn-menu"> 
      	<!--
          <input type="checkbox" id="btn-menu">
          <label for="btn-menu"  class="icon-menu">
          <img src="/imagen/para-todos/icono-menu.jpg" width="40px" height="40px">
          </label>
           -->       
          <div class="menu">
...
<!-------- Inicio Slider Imagenes(LayerSlider5) ------->

<!--<script src="include/propaganda-cambiante/LayerSlider-5-3-0/layerslider/js/jquery.js"></script>-->
<script src="/include/propaganda-cambiante/LayerSlider-5-3-0/layerslider/js/greensock.js"></script>

<!-- LayerSlider script files -->
<script src="/include/propaganda-cambiante/LayerSlider-5-3-0/layerslider/js/layerslider.transitions.js"></script>
<script src="/include/propaganda-cambiante/LayerSlider-5-3-0/layerslider/js/layerslider.kreaturamedia.jquery.js"></script>
...
<!-------- Fin Slider Imagenes(LayerSlider5) ------->
</body>
</html>