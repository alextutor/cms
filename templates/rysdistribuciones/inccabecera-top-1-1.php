<!-- Table: webparametros  filtrar por campo ccodparametro=0004 inccabecera-top-1-1.php valor cvalparametro=10
 Posicion = al Costado del logo(lado derecho generalmente) ; en la tabla  pagehome   se graba con cubidestino =10 -->
