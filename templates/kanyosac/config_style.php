...
<div id="warp" class="redondeado-10px" >  
	<div id="background">
	  <img src="/imagen/12172810/muebles-de-madera.jpg" alt="">
	</div>           
   <header id="cabecera">   
    	<div class="ctnlogo">
	...
	<!------------------------------ Fin  Cuerpo --------------------------------------------------------> 	
    <div id="piecontenido">
		<?php include $cRutaWeb."incpiecontenido.php"?>
    </div>
    
</div>  <!--- Fin  warp ----->	
 <footer id="PiePrincipal" class="redondeado-10px" >  
 	  	<img src="/imagen/12172816/solucion-servicios-pie-pagina.png" alt="">     	
