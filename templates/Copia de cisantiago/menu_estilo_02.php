	  ...
	  case "multidrop":
          ...
          <li class="zm-left-align">        
			...
			$nromenucab2 = db_num_rows($resmenucab2);
			  ?>
            <div class="zm-multi-column w-680">            
             <ul class="w-170">		<!-- Inicio Ul-1 2do menu multidrop  -->					
              <?php  
			while ($rowmenucab2 = db_fetch_array($resmenucab2)) //Inicio while 2
			{
				...
				if ($i2==8 or $i2==16 or $i2==24) {					
				?>
	                </ul>
                    <ul class="w-170">
                <?php  
				}
			    echo "<li><a href='".$enlacecab2."'>".$rowmenucab2['cnomseccion']. "</a></li>";            				
				$i2++;
 		    } //Fin while 2
			?>	                     					
            </div>          
