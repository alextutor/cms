...
//
$sqlhoy = "SELECT * "; 
$sqlhoy.= "FROM contador WHERE fechacorta=curdate()"; 
$eshoy = db_query($sqlhoy, $conexion) or die("Error al leer base de datos: ".mysql_error()); 
...
$men=$men . "<td align='left' width='50%'><font color=#ffffff>Total visitas:  $visitas  desde Diciembre del 2013</font></td>" . chr(10); 
$men=$men . 
"</tr>" . chr(10); 
